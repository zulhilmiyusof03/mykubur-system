                ...
                <div class="app-card app-section">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-4">
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch sm:items-end gap-2">
                            <button onclick="filterSearchWaris()" class="app-button-primary px-5 py-3 text-sm flex items-center justify-center gap-2 w-full sm:w-auto">
                ...
                <div class="app-card app-section space-y-6">
                    ...
                    <div class="app-panel p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-2 w-full sm:w-auto">
                            <label id="map-row-label" class="text-xs text-slate-500 font-bold uppercase whitespace-nowrap">Pilih Baris (1 - 57):</label>
                            <select id="map-row-select" onchange="renderVisualMap()" class="app-input w-full sm:w-32 text-xs font-semibold px-3 py-2.5">
                                <!-- JS auto populate baris -->
                            </select>
                        </div>
                    </div>
            ...
            <section id="tab-admin" class="tab-content hidden space-y-6">
                ...
                <div class="app-card overflow-hidden">
                    ...
                    <div class="p-4 bg-slate-50 border-b border-slate-200 grid grid-cols-1 sm:grid-cols-4 gap-3">
                        ...
                        <button onclick="filterAdminTable()" class="app-button-primary px-4 py-2 text-xs flex items-center justify-center gap-2">
                            <i data-lucide="search" class="w-4 h-4"></i> Search Kubur
                        </button>
                    ...
                    <div class="p-4 bg-white border-b border-slate-200 grid grid-cols-1 md:grid-cols-5 gap-3 items-end">
                        <div class="md:col-span-2">
                            <label class="app-label">Tambah Baris Kubur</label>
                            <select id="add-row-block" class="app-input text-xs px-3 py-2">
                                <option value="A">Blok A</option>
                                <option value="B">Blok B</option>
                                <option value="C">Blok C</option>
                            </select>
                        ...
                        <div>
                            <label class="app-label">Jumlah Baris</label>
                            <input type="number" id="add-row-count" min="1" max="50" value="1" class="app-input px-3 py-2 text-xs">
                        </div>
